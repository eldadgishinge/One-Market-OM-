...
for i in range(1000):
    print (" ")
    print (" ")
    choose = input("Choose from the categories below \n- Fruits\n- Phones\n- Vegetables\n- Drinks\n- Clothes\n- Art_object\n- Shoes\n- Cars\nName of categories: ")
    ...
    if choose == "Fruits":
        ...
        print("----------------CARS----------------")
        print("                                           ")
#The lists of rental cars and their rent  prices monthly to tour around Rwanda
...
>>>>>>> c19450fbc34fcb93866608a86b881f13eb054230
...
>>>>>>> 01b2d0bf4b5d661a863c302dc7b7d5ede710d25a
